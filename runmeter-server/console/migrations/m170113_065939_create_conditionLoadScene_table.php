...
class m170113_065939_create_conditionLoadScene_table extends Migration
{
    ...
    public function up()
    {
         ...
         */
        $this->createIndex(
            'conditionLoadScene_sceneButtonId_idx',
            'conditionLoadScene',
            'sceneButtonId'
        );
			
        $this->addForeignKey(
            'conditionLoadScene_sceneButtonId_sceneButton_sceneButtonId_fk',
            'conditionLoadScene',
            'sceneButtonId',
            'sceneButton',
            'sceneButtonId',
         ...
         */
        $this->createIndex(
            'conditionLoadScene_sceneId_idx',
            'conditionLoadScene',
            'sceneId'
        );
			
        $this->addForeignKey(
            'conditionLoadScene_sceneId_scene_sceneId_fk',
            'conditionLoadScene',
            'sceneId',
            'scene',
            'sceneId',
